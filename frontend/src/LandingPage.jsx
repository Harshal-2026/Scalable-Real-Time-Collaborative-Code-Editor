...
import { Code, Users, Zap, Terminal, Bot, FolderTree, MessageSquare, ArrowLeft, Shield, FileText, Mail, X } from "lucide-react";
import "./App.css";
...
function LandingPage() {
  ...
  return (
    <div className="landing-container">
      ...
      <main className={`hero-section ${showFeatures ? 'hidden' : ''}`}>
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            ...
            <button className="cta-button secondary" onClick={() => toggleFeatures(true)}>
              View Features
            </button>
          </div>
        </div>
      ...
      <div className={`features-overlay ${showFeatures ? 'active' : ''}`}>
