...
function Workspace() {
  ...
  // Auto-scroll AI Assistant messages
  useEffect(() => {
  ...
  // Auto-scroll Team Chat messages
  useEffect(() => {
  ...
  async function askAi() {
    ...
    try {
      ...
      const BACKEND_URL = import.meta.env.VITE_API_URL || (window.location.hostname === 'localhost' ? 'http://localhost:5000' : "https://scalable-real-time-collaborative-code.onrender.com");
      ...
      const response = await fetch(`${BACKEND_URL}/api/ai`, {
        ...
        body: JSON.stringify({
          ...
          code,
          language,
          history: aiMessages.slice(-10) // Send last 10 messages for context
        })
      });
    ...
    <div className={`workspace ${theme}`} style={{
      ...
      {isAIOpen && (
        ...
        >
          ...
          <div className="ai-popup-messages messages">
